...
const lockedAt17 = await romance.locator('[data-romance-locked]').count()
...
await page.getByRole('button', { name: '인연', exact: true }).click()
await page.waitForTimeout(300)
const lockedAt18 = await page.getByRole('dialog', { name: '인연' }).locator('[data-romance-locked]').count()
