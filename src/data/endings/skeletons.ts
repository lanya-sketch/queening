...
export const ENDING_SKELETONS: EndingSkeleton[] = [
  ...
  // ── 배드:참칭실패 — 스스로 황제를 칭했으나 전쟁에서 무너짐. 삼켜진 게 아니라 다 걸고 잃은 파국.
  {
    id: 'bad-usurp-failed',
    match: isTier('배드:참칭실패'),
    priority: 10,
    lines: [
      {
        speaker: 'narration',
        text:
          '스무 살의 왕은 스스로 황제를 칭했고, 스무 살의 왕은 그 관을 지키지 못했다.\n' +
          '무너지는 제국이라 여겼으나, 그 제국은 작은 나라 하나를 삼킬 힘은 아직 남아 있었다.',
      },
      ...body,
      {
        speaker: 'narration',
        text:
          '책봉을 받아 살아남는 길도 있었다. 왕으로 남는 길도 있었다. 그러나 {왕}은 전부를 걸었고,\n' +
          '전부를 잃었다. 나라는 제국의 한 지방으로 접혔고, 스스로 칭한 황제의 이름은\n' +
          '패자의 기록으로만 남았다. 가정교사가 가르치지 못한 것은, 언제 걸지 말아야 하는가였다.',
      },
    ],
  },
