...
export const TRUTH_EVENTS: GameEvent[] = [
    ...
    choices: [
      {
        ...
        resultText:
          ...
          '내가 안다는 걸 몰라야 합니다."\n' +
          '왕은 고개를 끄덕였다. 그날 이후 아이는 섭정공 앞에서 조금 더 ' +
      ...
      },
      {
        ...
        resultText:
          '왕은 변경 수비대에서 죽은 시종 이야기를 지나가듯 꺼냈다. 섭정공은 눈 하나 ' +
  ...
  },
  {
    ...
    text:
      ...
      '\n' +
      '왕은 서찰 한 통을 끝까지 읽고, 다시 처음부터 읽었다. 열두 살에 ' +
    ...
    choices: [
      {
        ...
        resultText:
          '왕은 서찰을 원래 자리에 돌려놓게 했다.\n' +
          '이듬해 알현에서 왕대비는 여전히 아들의 소맷단을 나무랐고, 왕은 ' +
