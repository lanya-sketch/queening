...
export const TRUTH_EVENTS: GameEvent[] = [
    ...
    choices: [
      {
        ...
        resultText:
          ...
          '내가 안다는 걸 몰라야 합니다."\n' +
          '{왕}은고개를 끄덕였다. 그날 이후 아이는 섭정공 앞에서 조금 더 ' +
      ...
      },
      {
        ...
        resultText:
          '{왕}은변경 수비대에서 죽은 시종 이야기를 지나가듯 꺼냈다. 섭정공은 눈 하나 ' +
  ...
  },
  {
    ...
    text:
      ...
      '\n' +
      '{왕}은서찰 한 통을 끝까지 읽고, 다시 처음부터 읽었다. 열두 살에 ' +
