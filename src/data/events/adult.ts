...
export const ADULT_EVENTS: GameEvent[] = [
  {
    ...
    title: '외조부의 제사',
    text:
      '모후의 친정에서 제사가 있었다. 군주는 외손으로서 참례했고, 당신은 ' +
      '수행으로 따라갔다.\n' +
      '기제가 끝나고 서고에 잠시 혼자 남았을 때, 당신은 문갑의 서찰 묶음을 보았다. ' +
      '모후의 필적이다. 받는 이는 그의 오라비 — 지금의 섭정.\n' +
      '남매가 편지를 주고받는 것은 죄가 아니다. 다만 묶음이 시작되는 날짜가 ' +
      '선황이 승하하기 두 달 전이고, 그 이전 것은 한 통도 없다는 게 마음에 걸린다.\n' +
      '발소리가 들려 당신은 문갑을 닫았다.',
    condition: {
      minAge: 16,
  ...
  },
  {
    ...
    title: '성년식',
    text:
      '관례(冠禮)다. 열일곱, 이 나라의 법이 정한 성년이다.\n' +
      '예법대로라면 오늘부로 섭정은 정사를 군주에게 돌려주어야 한다. ' +
      '예법대로 되지 않으리라는 것을 이 자리의 누구도 의심하지 않는다.\n' +
      '관을 씌우는 손이 섭정의 것이다. 그가 군주의 귀에만 들리게 말한다.\n' +
      '"이제 무엇을 하시겠습니까, 폐하."\n' +
      '9년을 준비한 대답을 해야 할 때다.',
    condition: { minAge: 17 },
    priority: 40,
    choices: [
      {
        ...
        resultText:
          '"오늘부로 과인이 친정한다."\n' +
          '한 문장이었다. 조정은 술렁였고, 섭정은 웃으며 절했다 — 물러나겠다는 ' +
          '절이 아니라, 받아들이겠다는 절도 아닌, 그저 예법에 맞는 절이었다.\n' +
          '그날 밤 궁의 위병이 두 배로 늘었다. 명분은 성년식 경비였다.',
      },
      {
        id: 'coexist',
        label: '섭정과의 공동 통치를 청한다',
        effects: [
        ...
        resultText:
          ...
          '섭정의 표정이 처음으로 흔들렸다. 그는 이 아이가 물러선 것인지, ' +
  ...
  },
  {
    ...
    title: '내명부의 약재',
    text:
      '섭정이 관여했다는 것까지는 왔다. 그런데 한 가지가 맞지 않는다.\n' +
      '선황을 무너뜨린 것은 오래 쌓이는 종류의 약이었다. 그런 것은 외조에서 ' +
      '들어오지 않는다. 어의원의 처방이 아니라 내명부의 재고에서만 나온다.\n' +
      '내명부는 조정의 관할이 아니다. 섭정의 손이 닿는 곳이 아니라는 뜻이다.\n' +
  ...
  },
  {
    ...
    title: '섭정과의 담판',
    text:
      '섭정이 사람을 물리고 당신들을 불렀다. 술이 나왔지만 아무도 마시지 않았다.\n' +
      '"폐하께서는 이제 저를 치실 수 있습니다." 그가 먼저 말했다. ' +
      '"신도 압니다. 다만 신을 치시면 귀족파 절반이 함께 일어설 것이고, ' +
      '그 절반을 폐하께서 감당하실 수 있는지는 신도 모르겠습니다."\n' +
      '그가 잔을 밀어 놓는다.\n' +
      '"신은 폐하께서 애송이가 아니라는 것을 압니다. 그것이 신이 폐하께 ' +
      '드릴 수 있는 전부입니다."',
    condition: {
      minAge: 18,
    ...
    choices: [
      {
        ...
        resultText:
          '군주가 잔을 들었다. 두 사람은 그날 밤 아무 약속도 문서로 남기지 않았고, ' +
          '그것이 이 궁에서 가장 확실한 종류의 약속이었다.\n' +
          '섭정은 이 아이가 자신을 필요로 한다고 믿고 있다. 절반은 사실이다.',
      },
      {
        id: 'defer',
        label: '대답을 미룬다',
        effects: [{ target: { kind: 'resource', key: 'regentRapport' }, amount: -5 }],
        setFlags: { regent_deferred: true },
        resultText:
          '"숙부의 말씀, 새겨듣겠습니다."\n' +
          '군주는 잔을 들지 않았다. 섭정은 실망하지 않았다 — 실망할 만큼 ' +
          '기대하지 않았다는 얼굴이었다.\n' +
  ...
  },
  {
    ...
    text:
      ...
      '섭정은 군주의 사람들을 하나씩 지방으로 돌리기 시작했다. 명분은 늘 ' +
      '흠잡을 데가 없었다 — 승진, 요직, 중임. 궁에서 멀어진다는 것만 빼면.\n' +
      '오늘 아침에는 당신의 이름이 목록에 올랐다는 말이 돌았다.\n' +
      '군주가 처음으로 당신 앞에서 목소리를 높였다. "과인이 지킵니다."',
    condition: { minAge: 18, resources: { regentSuspicion: { min: 70 } } },
    effects: [
      { target: { kind: 'resource', key: 'regentRapport' }, amount: -20 },
