...
export const YOUTH_EVENTS: GameEvent[] = [
  {
    ...
    title: '문서고의 밤',
    text:
      '선왕의 유품을 정리하라는 명이 내려왔다. 왕은 굳이 직접 하겠다고 했다.\n' +
    ...
    choices: [
      {
        ...
        resultText:
          '당신은 초안을 왕의 침실 마루 아래에 넣는다. 아이는 아무것도 묻지 않고 ' +
      ...
      },
      {
        ...
        resultText:
          ...
          '나라는 하루아침에 바뀌지 않지요." 그는 왕의 어깨를 짚으며 말했다. ' +
    ...
    choices: [
      {
        ...
        resultText:
          '왕은 더 묻지 않았다. 어린아이가 잊었다고 여겨지는 편이 낫다. ' +
      ...
      },
      {
        ...
        resultText:
          '왕은 사흘 내리 같은 것을 물었다. 넷째 날, 늙은 의관이 ' +
  ...
  },
  {
    ...
    title: '왕대비의 초대',
    text:
      '왕대비가 왕을 처소로 불렀다. 즉위 이후 처음 있는 사사로운 자리다.\n' +
    ...
    choices: [
      {
        ...
        resultText:
          ...
          '그 한 박자를 본 사람은 방 안에 둘뿐이었다. 왕은 눈치채지 못했고, ' +
      ...
      },
      {
        ...
        resultText:
          '왕은 배운 대로 인사하고 물러났다. 왕대비는 흡족해했고, 그 말은 ' +
          '섭정공의 귀에도 좋게 들어갔다.\n' +
