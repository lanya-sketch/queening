...
export const TEEN_EVENTS: GameEvent[] = [
  {
    ...
    title: '첫 친정',
    text:
      '가뭄이 들었다. 조정은 늘 하던 대로 창고를 열자고 했고, 섭정은 늘 하던 대로 ' +
      '재가했다. 그리고 처음으로, 군주가 입을 열었다.\n' +
      '"그 창고는 작년에도 열었습니다. 올해도 열면 내년에는 무엇을 엽니까."\n' +
      '조정이 조용해졌다. 섭정이 천천히 고개를 돌린다. "그러면 폐하께서는 ' +
      '어찌하시겠습니까."\n' +
    ...
    choices: [
      {
        ...
        resultText:
          '군주는 장부의 항목을 하나씩 짚어가며 어디가 새는지 말했다. 호부의 관원들이 ' +
          '얼굴을 붉혔다. 숫자 앞에서는 나이가 무기가 되지 않는다.\n' +
          '섭정은 반대하지 않았다. 회의가 끝난 뒤 그는 딱 한 마디를 남겼다. ' +
      ...
      },
      {
        ...
        resultText:
          '군주는 구휼미를 지방군의 손으로 옮기게 했다. 굶는 자에게 밥을 주는 일이 ' +
          '누구의 이름으로 이루어지는가 — 그것이 권력이라는 걸 아이는 이미 안다.\n' +
          '섭정은 그날 저녁 병부의 명단을 다시 살폈다고 한다. 경계가 시작되었다.',
      },
      {
        id: 'personnel',
        label: '인사를 개편한다',
        ...
        resultText:
          '군주는 창고를 여는 대신 창고를 지키는 사람을 바꿨다. 누가 누구의 사람인지 ' +
          '읽어내지 못하면 할 수 없는 수다.\n' +
      ...
      },
      {
        ...
        resultText:
          '"…아직, 생각이 부족했습니다."\n' +
          '조정이 다시 움직이기 시작했다. 아무도 웃지 않았지만, 아무도 놀라지도 않았다. ' +
          '그게 더 나빴다.\n' +
          '그날 밤 군주는 당신에게 아무것도 묻지 않았다. 처음 있는 일이었다.',
      },
    ],
  },
  {
    ...
    title: '귀족파의 견제',
    text:
      '상소가 올라왔다. 표면은 예법 문제다 — 군주의 교육이 "지나치게 한쪽에 치우쳐" ' +
      '있으며, 시강관을 늘려 균형을 잡아야 한다는 것.\n' +
      '이름은 거론되지 않았지만 모두가 당신을 보고 있었다. 당신을 떼어내겠다는 뜻이다.\n' +
      '군주가 당신을 한 번 보고, 상소를 다시 본다.',
    ...
    choices: [
      {
        ...
        resultText:
          ...
          '군주는 상소의 문장을 그대로 인용해 되돌려주었다. 문답 훈련에서 수백 번 ' +
          '해본 일이다. 상소를 올린 자가 말을 더듬었다.\n' +
          '섭정은 끝까지 개입하지 않았다. 그리고 그날 이후, 그가 군주를 부르는 ' +
          '호칭이 조금 달라졌다.',
      },
      {
        id: 'yield',
        ...
        resultText:
          '군주는 시강관을 늘리는 데 동의했다. 새 시강관들은 당신의 수업에 ' +
  ...
  },
  {
    ...
    title: '사라진 당직',
    text:
      '연회에서 주워들은 이야기다. 선황이 승하하던 밤 침전을 지킨 당직 환관이 ' +
      '있었고, 그는 이듬해 봄 남쪽 역참으로 자리를 옮겼다.\n' +
      '거기서 겨울을 넘기지 못했다. 병사(病死)로 기록되었다. 서른둘이었다.\n' +
      '역참으로 가는 인사는 보통 죄를 지은 자에게 내린다. 그는 아무 죄도 짓지 않았다.',
  ...
  },
  {
    ...
    title: '감사의 장부',
    text:
      '군주가 호부의 3년치 장부를 다시 뽑게 했다. 숫자를 읽을 줄 아는 군주는 ' +
      '조정에서 가장 성가신 존재다.\n' +
      '한 항목이 걸린다. 선황 승하 직후 여섯 달 동안, 명목 없는 지출이 ' +
    ...
    choices: [
      {
        ...
        resultText:
          '군주는 장부를 원래 자리에 돌려놓게 했다. 아는 것과 아는 척하는 것은 ' +
          '다르다 — 당신이 가르친 그대로다.\n' +
          '섭정은 감사가 조용히 끝난 것을 반겼다. 그는 이 아이가 다루기 쉽다고 ' +
      ...
      },
      {
        ...
        resultText:
          '군주는 숫자만 읽었다. 누구를 지목하지도, 죄를 묻지도 않았다. ' +
          '그저 "이 여섯 달이 이상합니다"라고만 했다.\n' +
          '조정이 얼어붙었다. 그날 이후 그 여섯 달을 입에 올리는 자가 없어졌고, ' +
