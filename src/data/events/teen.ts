...
export const TEEN_EVENTS: GameEvent[] = [
    ...
    choices: [
      {
        ...
        resultText:
          '왕은 장부의 항목을 하나씩 짚어가며 어디가 새는지 말했다. 재무청의 관리들이 ' +
      ...
      },
      {
        ...
        resultText:
          '왕은 구휼을 변경 수비대의 손으로 옮기게 했다. 굶는 자에게 빵을 주는 일이 ' +
      ...
      },
      {
        ...
        resultText:
          '왕은 곳간을 여는 대신 곳간을 지키는 사람을 바꿨다. 누가 누구의 사람인지 ' +
          '읽어내지 못하면 할 수 없는 수다.\n' +
      ...
      },
      {
        ...
        resultText:
          ...
          '그게 더 나빴다.\n' +
          '그날 밤 왕은 당신에게 아무것도 묻지 않았다. 처음 있는 일이었다.',
      },
    ],
  },
  {
    ...
    choices: [
      {
        ...
        resultText:
          ...
          '왕은 청원서의 문장을 그대로 인용해 되돌려주었다. 문답 훈련에서 수백 번 ' +
          '해본 일이다. 청원서를 올린 백작이 말을 더듬었다.\n' +
          '섭정공은 끝까지 개입하지 않았다. 그리고 그날 이후, 그가 왕을 부르는 ' +
          '호칭이 조금 달라졌다.',
      },
      {
        id: 'yield',
        ...
        resultText:
          '왕은 시학관을 늘리는 데 동의했다. 새 시학관들은 당신의 수업에 ' +
  ...
  },
  {
    ...
    title: '국고의 장부',
    text:
      '왕이 재무청의 3년치 장부를 다시 뽑게 했다. 숫자를 읽을 줄 아는 왕은 ' +
      '궁정에서 가장 성가신 존재다.\n' +
    ...
    choices: [
      {
        ...
        resultText:
          '왕은 장부를 원래 자리에 돌려놓게 했다. 아는 것과 아는 척하는 것은 ' +
          '다르다 — 당신이 가르친 그대로다.\n' +
      ...
      },
      {
        ...
        resultText:
          '왕은 숫자만 읽었다. 누구를 지목하지도, 죄를 묻지도 않았다. ' +
