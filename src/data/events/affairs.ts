...
export const AFFAIR_EVENTS: GameEvent[] = [
    ...
    choices: [
      {
        ...
        resultText:
          '왕은 국경에 기를 세웠다. 배상은 없었고, 사절은 웃으며 돌아갔다. ' +
      ...
      },
      {
        ...
        resultText:
          '왕은 배상 대신 소금과 철의 통행세를 걸었다. 사절은 계산을 마치고 표정을 고쳤다 — ' +
      ...
      },
      {
        ...
        resultText:
          ...
          '사절이 떠나던 날 왕은 성벽에 오르지 않았다. 배웅하지 않아도 되는 것이 ' +
          '그날 왕이 지킨 유일한 것이었다.',
      },
      {
        id: 'delegate',
        ...
        resultText:
          ...
          '그가 유능하다는 것은 사실이다.\n' +
          '다만 사절이 왕에게 인사한 것은 도착한 날 한 번뿐이었다. 제국은 이 왕국에서 ' +
...

  {
    ...
    text:
      ...
      '영주들의 땅에서 뽑혀 온 평민들이 그 방에 앉아 조세와 부역을 논한다. 왕이 영주를 ' +
      ...
      '그가 처음으로 왕에게 결정을 넘겼다. 그것 자체가 시험이다.',
    ...
    choices: [
      {
        ...
        resultText:
          ...
          '하겠는가."\n' +
          '그날 하원의 평민들은 왕의 이름을 소리 내어 불렀다. 궁 서편에서 그런 소리가 난 ' +
          '것은 처음이었다.\n' +
          '그리고 그날 이후 왕은 아버지가 섰던 자리에 서게 되었다. 그 자리가 어떤 자리였는지는, ' +
      ...
      },
      {
        ...
        setFlags: { house_commons_defended: true, people_relieved_commons: true },
        resultText:
          '왕은 어전에서 아무 말도 하지 않았다. 대신 동의안에 이름을 올린 백작 셋을 따로 ' +
          '만났다. 하나에게는 아들의 자리를, 하나에게는 묵은 소송의 종결을, 하나에게는 ' +
          '그저 시간을 주었다.\n' +
          '동의안은 표결에 오르지 못하고 흐지부지되었다. 하원은 남았고, 아무도 왕이 그것을 ' +
          '지켰다는 것을 알지 못했다.',
      },
      {
        id: 'dissolve',
        ...
        resultText:
          '왕은 해산에 서명했다. 손이 떨리지 않았다.\n' +
          '평민들이 방을 비우는 데 이틀이 걸렸다. 그들이 가져온 것은 많지 않았고, ' +
          '가져갈 것은 더 적었다.\n' +
          '그날 밤 왕이 물었다. "스승님. 아버님께서는 왜 그 방을 만드셨습니까."\n' +
      ...
      },
      {
        ...
        resultText:
          '"숙부께서 정하십시오."\n' +
          '섭정공은 잠깐 왕을 보았다. 안도인지 실망인지 알 수 없는 얼굴이었다. ' +
          '어쩌면 둘 다였을 것이다.\n' +
          '방은 그달 안에 비었다. 절차는 흠잡을 데가 없었고, 어디에도 왕의 이름은 ' +
          '적히지 않았다.',
      },
    ],
  },
